jQuery(function() {
            ...
            switch (c.removeClass("state-" + k),
                ...
                case "ready":
                    u.addClass("element-invisible"),
                        o("#filePicker_slide2").removeClass("element-invisible"),
                    ...
                    break;
                case "uploading":
                    o("#filePicker_slide2").addClass("element-invisible"),
                        f.show(),
                        c.text("暂停上传");
                    break;
                case "paused":
    ...
    var n, o = jQuery, r = o("#uploader1"), l = o('<ul class="filelist"></ul>').appendTo(r.find(".queueList")), d = r.find(".statusBar"), p = d.find(".info"), c = r.find(".uploadBtn"), u = r.find(".placeholder"), f = d.find(".progress").hide(), m = 0, h = 0, g = window.devicePixelRatio || 1, v = 110 * g, b = 110 * g, k = "pedding", w = {}, x = function() {
