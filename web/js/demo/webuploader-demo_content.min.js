jQuery(function() {
    ...
    function i() {
        ...
        e.uploadFailNum && (a = "已成功上传" + e.successNum + "张照片至XX相册，" + e.uploadFailNum + '张照片上传失败，<a class="retry" href="#">重新上传</a>失败图片或<a class="ignore" href="#">忽略</a>')) : (e = n.getStats(),
            ...
            switch (c.removeClass("state-" + k),
                ...
                case "ready":
                    u.addClass("element-invisible"),
                        o("#filePicker_content2").removeClass("element-invisible"),
                    ...
                    break;
                case "uploading":
                    o("#filePicker_content2").addClass("element-invisible"),
                        f.show(),
                        c.text("暂停上传");
                    break;
                case "paused":
    ...
    var n, o = jQuery, r = o("#uploader2"), l = o('<ul class="filelist"></ul>').appendTo(r.find(".queueList")), d = r.find(".statusBar"), p = d.find(".info"), c = r.find(".uploadBtn"), u = r.find(".placeholder"), f = d.find(".progress").hide(), m = 0, h = 0, g = window.devicePixelRatio || 1, v = 110 * g, b = 110 * g, k = "pedding", w = {}, x = function() {
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: "http://localhost:8080/ketuan/applet/images/upload",
        fileNumLimit: 20,
        fileSizeLimit: 20971580,
        fileSingleSizeLimit: 1048576
    }),
        n.addButton({
            id: "#filePicker_content2",
            label: "继续添加"
        }),
        ...
        n.on("uploadSuccess",function (file,response) {
            ...
            if(response!=null){
                contentImgs.push(response[0]);
            }
        }),
        // n.on("uploadComplete",function (e) {
        //     alert("complete"+e.toString())
        // })
