...
-- Schema ketuanDB
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `ketuanDB` ;

-- -----------------------------------------------------
-- Schema ketuanDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ketuanDB` DEFAULT CHARACTER SET utf8 ;
USE `ketuanDB` ;

-- -----------------------------------------------------
-- Table `ketuanDB`.`USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`USER` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`USER` (
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`MERCHANT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`MERCHANT` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`MERCHANT` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`PRODUCT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`PRODUCT` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`PRODUCT` (
  `id` VARCHAR(32) NOT NULL,
  ...
  CONSTRAINT `fk_PRODUCT_MERCHANT1`
    ...
    REFERENCES `ketuanDB`.`MERCHANT` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`GROUP`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`GROUP` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`GROUP` (
  `id` VARCHAR(32) NOT NULL,
  ...
  `group_state` INT ZEROFILL NOT NULL COMMENT '团状态',
  ...
  CONSTRAINT `fk_GROUP_PRODUCT1`
    ...
    REFERENCES `ketuanDB`.`PRODUCT` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`TRACK`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`TRACK` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`TRACK` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`ORDER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`ORDER` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`ORDER` (
  `id` VARCHAR(32) NOT NULL,
  `PRODUCT_id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`SENDADDRESS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`SENDADDRESS` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`SENDADDRESS` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`MESSAGE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`MESSAGE` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`MESSAGE` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`IMAGE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`IMAGE` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`IMAGE` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`COMMENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`COMMENT` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`COMMENT` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`CASHBACK_CALCULATE_STAND`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`CASHBACK_CALCULATE_STAND` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`CASHBACK_CALCULATE_STAND` (
  `id` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ketuanDB`.`CASHBACK`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ketuanDB`.`CASHBACK` ;

CREATE TABLE IF NOT EXISTS `ketuanDB`.`CASHBACK` (
  `id` VARCHAR(32) NOT NULL,
  ...
  CONSTRAINT `fk_CASHBACK_CASHBACK_CALCULATE_STAND1`
    ...
    REFERENCES `ketuanDB`.`CASHBACK_CALCULATE_STAND` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
